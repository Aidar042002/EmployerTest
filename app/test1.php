...
<html lang="ru">
  ...
  <body>
    <div class="header">
      <h1>Тест для профессии "Программист C++, Java, C Sharp, Go"<a href="index.php" style="float:right;">На главную</a></h1>
    </div>
    <div class="main">
        ...
        if(isset($_POST['send'])){
          ...
          for($i=0; $i<$count; $i++){
            ...
            VALUES ('{$_POST['pvk'][$i]}', '{$id}',1 ,'{$_POST['rate'][$_POST['pvk'][$i]-1]}')");
